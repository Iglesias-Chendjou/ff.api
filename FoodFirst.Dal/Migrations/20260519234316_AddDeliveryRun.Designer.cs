...
namespace FoodFirst.Dal.Migrations
{
    ...
    [Migration("20260519234316_AddDeliveryRun")]
    partial class AddDeliveryRun
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FoodFirst.Dal.Entities.DeliveryRun", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("DeliveryPersonUserId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("DeliveryPersonUserId");
            ...
            modelBuilder.Entity("FoodFirst.Dal.Entities.Membership", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("FoodFirst.Dal.Entities.StoreInventory", b =>
                {
                    ...
                    b.Property<int?>("DiscountPercentOverride")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("UnsellableSubReason")
                        .HasMaxLength(30)
                        .HasColumnType("nvarchar(30)");
            ...
            modelBuilder.Entity("FoodFirst.Dal.Entities.StorePickup", b =>
                {
                    ...
                    b.Property<Guid>("CollectionRunId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("StoreSignatureUrl")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");

                    b.Property<decimal?>("TemperatureAtPickup")
                        .HasPrecision(5, 2)
            ...
            modelBuilder.Entity("FoodFirst.Dal.Entities.StorePickupItem", b =>
                {
                    ...
                    b.Property<string>("NonConformityReason")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");
            ...
            modelBuilder.Entity("FoodFirst.Dal.Entities.CollectionRun", b =>
                {
                    b.HasOne("FoodFirst.Dal.Entities.User", "Collector")
            ...
            modelBuilder.Entity("FoodFirst.Dal.Entities.Delivery", b =>
                {
                    ...
                    b.HasOne("FoodFirst.Dal.Entities.DeliveryRun", "DeliveryRun")
                        .WithMany("Deliveries")
            ...
            modelBuilder.Entity("FoodFirst.Dal.Entities.DeliveryRun", b =>
                {
                    b.HasOne("FoodFirst.Dal.Entities.User", "DeliveryPersonUser")
                        .WithMany("DeliveryRuns")
                        .HasForeignKey("DeliveryPersonUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                    ...
                    b.Navigation("DeliveryPersonUser");
            ...
            modelBuilder.Entity("FoodFirst.Dal.Entities.Membership", b =>
                {
                    b.HasOne("FoodFirst.Dal.Entities.User", "User")
                        .WithOne("Membership")
                        .HasForeignKey("FoodFirst.Dal.Entities.Membership", "UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("FoodFirst.Dal.Entities.Order", b =>
                {
                    ...
                    b.HasOne("FoodFirst.Dal.Entities.User", "PreparedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("FoodFirst.Dal.Entities.StorePickup", b =>
                {
                    b.HasOne("FoodFirst.Dal.Entities.CollectionRun", "CollectionRun")
                        .WithMany("Pickups")
            ...
            modelBuilder.Entity("FoodFirst.Dal.Entities.StorePickupItem", b =>
                {
                    ...
                    b.HasOne("FoodFirst.Dal.Entities.StorePickup", "StorePickup")
                        .WithMany("Items")
